...
const AboutUs : FC = () => {
  ...
  return(
    <section 
      ...
      flex flex-col bg-zinc-200 py-20 px-10 text-3xl md:text-4xl text-zinc-800" 
      
      >
      <div className="container mx-auto">
        <p className="leading-tight max-w-5xl mx-auto
             text-4xl lg:text-5xl tracking-tight" >
          <strong>
            We will help you ship better app, faster.
          </strong>
            Our team of expert engineers has created the best user experinces in some
